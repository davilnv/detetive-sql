...
public class Inventario extends JPanel{
	...
	public Inventario(Personagem personagem, Personagem personagem2) throws IOException {
		...
		iconeCoracao = ImageIO.read(getClass().getClassLoader().getResourceAsStream("iconeCoracao.png"));
		iconeEstrela = ImageIO.read(getClass().getClassLoader().getResourceAsStream("iconeEstrela.png"));
		add(sairButton);
	}
