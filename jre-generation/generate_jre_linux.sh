...
JAR_PATH="../target/detetive-sql-1.0-SNAPSHOT-jar-with-dependencies.jar"

# Caminho para o diretório de saída
OUTPUT_DIR="linux/detective_sql_jre_linux"
...
echo '#!/bin/sh
      ...
      "$appdir/bin/java" -Dprism.order=sw -Dprism.verbose=true -jar "$appdir/bin/detetive-sql-1.0-SNAPSHOT-jar-with-dependencies.jar"' > $OUTPUT_DIR/execute.sh
